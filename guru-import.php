...
$tabel     = 'guru_' . $jenjang;
$slugMenu  = 'guru-' . $jenjang;
$backUrl   = 'guru-' . $jenjang . '.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['upload']))
{
    ...
    else
    {
        ...
        $service = new GuruImportService($pdo);
        ...
        try
        {
            ...
            if ($gagal === 0 && $sukses > 0)
            {
                $flashHtml = flashMsg(
                    'success',
                    "Berhasil mengimpor <strong>{$sukses}</strong> data guru {$jenjangUp}."
                );
            }
...
$instructions = [
    ...
    'Kolom bertanda <strong>*</strong> (Nama, Jenis Kelamin) wajib diisi.',
    'Jenis Kelamin diisi dengan <strong>L</strong> (Laki-laki) atau <strong>P</strong> (Perempuan).',
    'Untuk kolom <strong>Status Pegawai</strong>, <strong>Jenis GTK</strong>, dan <strong>Jabatan</strong>, gunakan nilai dari sheet <em>Referensi</em>.',
    'Format tanggal lahir: <strong>YYYY-MM-DD</strong> atau <strong>DD/MM/YYYY</strong>.',
    'Kolom Tahun Masuk cukup diisi <strong>4 digit tahun</strong>, contoh: <strong>2015</strong>.',
    '<strong>NIK harus unik</strong> — tidak boleh ada yang sama di database.',
    'Jika ada 1 baris gagal, <strong>seluruh import dibatalkan</strong> (rollback).',
    'Ukuran file maksimal <strong>10 MB</strong>.',
];

$title = 'Upload Guru ' . $jenjangUp;
?>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-gray-500 mb-3">
                                        Unduh template Excel, isi data guru, lalu upload kembali di langkah 2.
                                    </p>
