...
if ($_SERVER['REQUEST_METHOD'] === 'POST')
{
    ...
    if (empty($errors))
    {
        ...
        // INI YANG DIPERBAIKI: PASTIKAN SEMUA FIELD INTEGER PAKAI null JIKA KOSONG
        $data = [
            // Data utama
            'nama'                  => $post['nama'],
            'nis'                   => $post['nis'],
        ...
        try
        {
            createSiswa($link, $tabel, $data);

            $_SESSION['msg_success'] = "Siswa berhasil ditambahkan!";
            header("Location: siswa-$jenjang.php?pesan=Siswa berhasil ditambahkan");
            exit;
        }
